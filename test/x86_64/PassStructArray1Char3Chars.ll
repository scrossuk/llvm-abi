...
define void @caller(i64 %coerce0, i24 %coerce1) {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %3, i8* align 8 %4, i64 11, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %6, i8* align 1 %7, i64 11, i1 false)
